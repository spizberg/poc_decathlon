...
################################################################################
## Form generated from reading UI file 'idshoes_poc_decathlon_demo_windowvimOmh.ui'
##
...
class Ui_DemoWindow(object):
    def setupUi(self, DemoWindow):
        ...
        self.label_3.setPixmap(QPixmap(u":/imageModele/CETI.png"))
        ...
        self.pushButtonStop.setMaximumSize(QSize(16777215, 16777212))
    ...
    def retranslateUi(self, DemoWindow):
        ...
        self.labelDemoTitle.setText(QCoreApplication.translate("DemoWindow", u"IDSHOES - CELLULE DE PRISE DE PHOTOS AUTOMATISE", None))
        ...
        self.pushButtonStart.setText(QCoreApplication.translate("DemoWindow", u"START", None))
        self.pushButtonStop.setText(QCoreApplication.translate("DemoWindow", u"STOP", None))
