...
################################################################################
## Form generated from reading UI file 'idshoes_poc_decathlon.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelImageCETI.setMinimumSize(QSize(400, 200))
        self.labelImageCETI.setMaximumSize(QSize(300, 300))
        font1 = QFont()
        font1.setPointSize(10)
        self.labelImageCETI.setFont(font1)
        self.labelImageCETI.setPixmap(QPixmap(u":/imageModele/Decathlon_Logo_real.svg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelTitle.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>IDSHOES </p><p>- </p><p>CELLULE D'IDENTIFICATION DE MODELE DE CHAUSSURE</p></body></html>", None))
